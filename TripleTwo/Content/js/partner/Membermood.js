...
function GetCustomerMood(pageindex, pagesize, sortby, searchby) {
...
function GetCustomerMood() {
    ...
    $(document).on("click", ".pagination", function (event) {
        ...
        var sortby = 1; //$('#SortBy').val();
        var searchby = '';//$('#Searchstr').val();
        GetCustomerMood(pageindex, pagesize, sortby, searchby);
    });
    $(document).on("change", '#ddlpagesize', function (event) {
